package com.jcseg.extractor.impl;

import com.jcseg.extractor.KeyphraseExtractor;
import com.jcseg.tokenizer.core.ISegment;
import com.jcseg.tokenizer.core.IWord;
import com.jcseg.util.IStringBuffer;
    ...
    */
    ...
    public List<String> getKeyphrase(Reader reader) throws IOException 
    {
        ...
        for ( int c = 0; c < maxIterateNum; c++ ) {
            for ( Entry<IWord, List<IWord>> entry : winMap.entrySet() ) {
        ...
        List<Entry<IWord, Float>> entryList = new ArrayList<Entry<IWord, Float>>(score.entrySet());
        Collections.sort(entryList, new Comparator<Entry<IWord, Float>>(){
            @Override
        ...
        for ( Entry<IWord, Float> entry : entryList ) {
        ...
        */
        ...
        for ( int i = 0; i < entryList.size(); ) {
            Entry<IWord, Float> entry = entryList.get(i);
