...
public class Kmeans {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Kmeans kmeans = new Kmeans(vec.getWordMap(), Integer.parseInt("20"),Integer.parseInt("10"));
        Classes[] explain = kmeans.explain();

        File fw = new File("D:\\Java\\generator\\gxtj\\src\\main\\resources\\library\\comment\\2.txt");
