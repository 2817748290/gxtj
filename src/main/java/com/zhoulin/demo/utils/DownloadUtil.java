...
public class DownloadUtil {
    ...
    /**
     * 下载 “上传工具类”上传的文件
     * @param odexName 存储的文件相对路径+文件名
     * @param request
     * @param response
     */
    public static void downUploadFile(String odexName,HttpServletRequest request, HttpServletResponse response){
        downFile(odexName,"upload",request,response);
    }

    /**
     * 通用下载类
     * @param odexName 文件名
     * @param dirName 存储的文件相对路径
     * @param request
     * @param response
     */
    public static void downFile(String odexName,String dirName,HttpServletRequest request, HttpServletResponse response){
        File downloadFile = new File(CommonUtil.getProjectFilePath() +"/"+ dirName + "/" + odexName);//要下载的文件
